firebase.initializeApp({
    messagingSenderId: '787177783154'
});
...
if (
    ...
    messaging.onMessage(function(payload) {
        ...
        info_message
            .text('')
            .append('<strong>'+payload.data.twi_title+'</strong>')
            .append('<em>'+payload.data.twi_body+'</em>')
        ;
...
function sendNotification(notification) {
    var key = 'AAAAt0dzv3I:APA91bH4PBZu5DbALVY68CxHxKKwVWP2djXKElE4-wkiGoryf7AuW11aFxNxMoohOmVrxuCLEX0uttNrcF2nuveXzVwJTpNE8BMMvMJlijGmW-bomFnsOpYPc5QqIUWw_7EU7abALo2t';
